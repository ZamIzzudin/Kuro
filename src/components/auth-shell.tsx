  ...
  return (
    ...
    >
      <div className="w-full max-w-[420px]">
        <div className={cn('rounded-xl border border-line bg-surface p-8 shadow-lg', className)}>
          <Brand subtitle="Time & Task Tracker" className="mb-7" />
          <h1 className="mb-1.5 text-[26px] font-extrabold tracking-tight">{title}</h1>
          {subtitle && <p className="mb-6 text-sm leading-relaxed text-ink-500">{subtitle}</p>}
          {children}
        </div>
      </div>
    </div>
